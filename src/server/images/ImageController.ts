...
import { addDoc, collection, CollectionReference, deleteDoc, doc, DocumentReference, Firestore, getDoc, getDocs, limit, query } from "firebase/firestore";
import { IImage, IListImage } from "../../types/images";
...
export default class ImageController
{
  ...
  public async RmImage(id: string, auth: Auth): Promise<string>
  {
    ...
    if(targetDoc.data()?.author !== auth.currentUser?.email)
